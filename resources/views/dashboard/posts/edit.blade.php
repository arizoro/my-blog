...
<div class="col-lg-8 mt-4">
  <form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data" >
    ...
    <button type="submit" class="btn btn-primary mb-5" onclick="return confirm('Are you sure ??')" >Update Post</button>
    <a href="/dashboard/posts" class="btn btn-warning mb-5" >Cancel</a>
  </form>
</div>
