<div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
  <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="sidebarMenuLabel">Arie.Blog</h5>
      ...
      <ul class="nav flex-column mb-auto">
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center gap-2 {{ Request::is('dashboard/categories*') ? 'text-primary' : 'text-dark' }}" href="/dashboard/categories">
            <i class="bi bi-grid mb-1"></i>Post Categories
          </a>
        </li>
      </ul>
      @endcan
        ...
        <li class="nav-item mb-2" >
          <form action="/logout" method="post">
            ...
            <div class="nav-item ">
              ...
              <svg class="bi"><use xlink:href="#door-closed"/></svg> Sign up</button>
            </div>
          </form>
        </li>
      </ul>
